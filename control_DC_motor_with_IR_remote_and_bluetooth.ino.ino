...
//    Serial.println("value received by the bluetooth is:");     
//    Serial.println(IncomingVal); 
            
    if(IncomingVal == "motSpeed"){           
//      Serial.println(motor_speed);
      performActions("motSpeed");} 
    else if(IncomingVal == "speedDown" ){performActions("speedDown");} 
    else if(IncomingVal == "speedUp" ){performActions("speedUp");}
    else if(IncomingVal == "stopPlay" ){performActions("stopPlay");}
    else if(IncomingVal == "directionLeft" ){performActions("directionLeft");}
    else if(IncomingVal == "directionRight" ){performActions("directionRight");}
    else if(IncomingVal == "inc100" ){performActions("inc100");}
    else if(IncomingVal == "dec100" ){performActions("dec100");}
    else if(IncomingVal == "startFromZero" ){performActions("startFromZero");}
